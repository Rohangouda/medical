                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col">
                                    <h4 class="card-title text-success">Product Slider</h4>
                                </div>
                            ...
                            <div class="modal-dialog mt-5">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header bg-success">
                                        <h5 class="modal-title">Add Product Slider</h5>
...
<script>
    $(document).ready(function(){
        ...
        function getProductData() {
            ...
            $.ajax({
                url: baseUrl + '/admin/product-slider/get-product-records',
                type: 'POST',
                data: {
                    '_token': '{{csrf_token()}}'
                },
                    ...
                    if (resp.status == 200) {
                        ...
                        $.each(resp.data, function(iKey, iVal){
                            x+= '<tr>'+
                                ...
                                '<td><img src="'+ baseUrl +'/storage/product_themes/'+ iVal.image_name +'" style="max-height:60px;"></td>'+
                                '<td>'+iVal.order_id+'</td>'+
                        ...
                        $("#home_slider").html('<tr><td colspan="4" style="text-align:center;">'+resp.msg+'</td></tr>');
                    }
                },
                complete: function () {
                    $("#loader").modal('hide');
        ...
        $('#add_staff_final_btn').click(()=>{
         ...
         $.ajax({
            url: baseUrl + '/admin/product-slider/add-product-image',
            type: 'POST',
            data: formdata,
            dataType: 'json',
            beforeSend: function() {
        ...
        $.ajax({
            url: baseUrl + '/admin/product-slider/update',
            type: 'POST',
            data: formdata,
            dataType: 'json',
            beforeSend: function() {
        ...
        $(document).on('click','.edit_slider_record', function() {
            ...
            if(slider_edit != ''){
                $.ajax({
                    url: baseUrl+'/admin/product-slider/edit-slider-detail',
                    type: 'POST',
                    data: {
                        '_token': '{{csrf_token()}}',
                    ...
                    success: function(res){
                        if(res.status == 200){
                            ...
                            $('.edit_theme_image').attr('src',baseUrl+'/storage/product_themes/'+res.data.image_name);
        ...
        if (confirm("Are you sure, you want to delete this slider on your database")) {
            ...
            if (slider_id == '') {
                ...
                $.ajax({
                    url: baseUrl + '/admin/product-slider/delete-slider',
                    type: 'POST',
                    data: {
                        '_token': '{{csrf_token()}}',
                        'id': slider_id
