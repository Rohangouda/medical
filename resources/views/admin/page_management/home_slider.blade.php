...
@section('content')
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form>
                                            ...
                                            <div class="modal-footer bg-success">
                                                <button type="button" class="btn btn-primary" id="add_image_final_btn">Submit</button>
                    ...
                    <div class="modal-body">
                        <div class="col-md-9">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <img src="" id="selected_image" class="edit_theme_image img img-border img-padding"  width="200px">
                            </div>
                            <div class="form-group col-md-12">
    ...
    <script>
        $(document).ready(function(){
            ...
            $.ajax({
                ...
                success: function(resp) {
                    if(resp.status == 200) {
                        ...
                        $('#order_err').html(resp.msg).css('display','block')
                    }
                },
                complete: function() {
                    $("#loader").modal('hide');
            ...
            var formdata = new FormData();
            // formdata.append('old_image', $('#old_image').val());
            formdata.append('image_name', $('#imge_name')[0].files[0]);
            ...
            $.ajax({
                ...
                success: function(resp) {
                    if(resp.status == 200) {
                        ...
                        $('#order_err1').html(resp.msg).css('display','block')
                    }
                },
                complete: function() {
                    $("#loader").modal('hide');
...
//                                $('#image_name').val(res.data.image_name);
//                                $('selected_image').change(function(){
//                                    alert("The iamge has been changed.");
//                                });
